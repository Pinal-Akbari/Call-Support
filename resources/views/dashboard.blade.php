      ...
      <div class="glass-panel" style="margin-bottom: 24px;">
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:8px;">
          ...
          <div>
            ...
            <p style="font-size:12px; color:var(--text-muted); margin:2px 0 0;">Rings agent extension <strong style="color:#a5b4fc;">{{ $agentCode }}</strong> first, then connects to the mapped number securely via BSNL DID masking.</p>
          </div>
        </div>
        ...
        <form id="moduleCallForm">
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px; margin-top:16px;">
            <button type="button" id="btnCallCustomer" class="btn btn-primary call-action-btn" onclick="triggerCallTarget('customer')">
